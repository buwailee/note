...
\para \label{regular}设$U$是流形$M$上的开集且$V\subset U$，则存在$V$的一个开覆盖$\{W_\alpha\}_{\alpha\in I}$使得对每个$\alpha$成立$\overline{W_\alpha}\subset V$.
...
\para \label{localpro}设$V\subset U$，如果$\omega|_V=0$，则$(\dd \omega)|_V=0$，即$\dd$是一个局部算符。
