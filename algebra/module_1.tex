...
\para 我觉得这个看上去有些奇怪的条件在最“自由”地补充进所有可能的分式的时候会自然产生。

首先注意到$k[x]_x=k[x,1/x]=k[x,y]/\langle xy-1\rangle$，这个在几何上就是说$k-\{0\}$和$xy=1$这条曲线同构。考虑$S$是$R$的任意子集，我们可以类比定义一个环$T$
\[
T=R\bigl[\{x_s\,:\, s\in S\}\bigr]\big/\bigl\langle\{sx_s-1\,:\, s\in S\}\bigr\rangle.
\]
