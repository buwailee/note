...
\usepackage[left=19mm,text={148mm,200mm},paperwidth=186mm,paperheight=250mm,includehead,vmarginratio=1:1]{geometry}
\usepackage{ctex}
\begin{document}
\begin{center}
\Large{Table of Formulas in Vector Analysis}\\
\footnotesize{LXX@Shanghai Nan Yang Model High School}
\end{center}
\noindent Definition:\\
