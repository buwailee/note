...
% \[
% \begin{aligned}
% 	G_{ab}(k,\omega)=&\frac{\delta_{ab}}{2\pi}\int_{\mathbb{R}^2}\frac{\sgn(\tau)\mathrm{d}x\mathrm{d}\tau}{(x^2+u_c^2\tau^2)^{\alpha/2}}\biggl[\frac{\exp(\ii (k_F-k) x)\exp(\ii \omega\tau)}{(\ii x+u_c\tau)^{1/N}(\ii x+u_s\tau)^{1-1/N}}+\frac{\exp(-\ii (k_F+k) x)\exp(\ii \omega\tau)}{(-\ii x+u_c\tau)^{1/N}(-\ii x+u_s\tau)^{1-1/N}}\biggr]\\
